...
var BitcoinPrice = function () {
  function BitcoinPrice() {
    var _this = this; //una lista de observers que empieza vacia


    this.observers = [];
    var el = document.querySelector('#value'); //cuando value cambia el valor
...
value.subscribe(display); //ocurre despues de cierto tiempo 5segundos
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42673" + '/');
